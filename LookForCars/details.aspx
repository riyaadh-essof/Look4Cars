...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function myFunction() {
            <%--document.getElementById("demo").innerHTML = "R" + document.getElementById('<%= txtInitital.ClientID %>').value;
            document.getElementById("Finance2").innerHTML = "R" + document.getElementById('<%= txtInitital.ClientID %>').value;--%>
            ...
            document.getElementById("Finance2").innerHTML = "R" + (Math.round(total * 100) / 100);
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField runat="server" ID="txtInitital"></asp:HiddenField>
    <!-- Page Inner-->
    <section>
            ...
            <div class="row">
                    ...
                    <div class="card c-brd-light mb-4 right-sidebar-widget">
                        <div class="c-bg-light">
                            <div class="card-body p-3">
                                <h6 class="mb-0">Finance Repayment Calculator</h6>
                            </div>
                        </div>
                        <div class="card-body py-4 bg-white">
                            ...
                            <div class="form-group">
                                <input id="sliderdeposit" runat="server" data-ui-slider="" type="text" value="10000" data-slider-min="0" data-slider-max="10000" data-slider-step="10000" data-slider-value="10000" data-slider-orientation="horizontal" class="slider slider-horizontal" onchange="myFunction()">
                            </div>
                            <label class="c-dark mb-3">Interest Rate (%)</label>
                            <div class="form-group">
                                <input id="interest" data-ui-slider="" type="text" value="13" data-slider-min="11" data-slider-max="18" data-slider-step="0.5" data-slider-value="13" data-slider-orientation="horizontal" class="slider slider-horizontal" onchange="myFunction()">
                            </div>
                            <label class="c-dark mb-3">Balloon Payment (%)</label>
                            <div class="form-group">
                                <input id="balloon" data-ui-slider="" type="text" value="0" data-slider-min="0" data-slider-max="30" data-slider-step="2.5" data-slider-value="0" data-slider-orientation="horizontal" class="slider slider-horizontal" onchange="myFunction()">
                            </div>
                            <label class="c-dark mb-3">Loan Period (month)</label>
                            <div class="form-group">
                                <input id="repayments" data-ui-slider="" type="text" value="72" data-slider-min="12" data-slider-max="72" data-slider-step="12" data-slider-value="72" data-slider-orientation="horizontal" class="slider slider-horizontal" onchange="myFunction()">
                            </div>
                ...
                <div class="col-4 col-lg-4 col-sm-12 col-xs-12">
                    <div class="card c-brd-light mb-4 right-sidebar-widget">
                        <div class="c-bg-light">
                            <div class="card-body p-3">
                                <h6 class="mb-0">Your Repayments</h6>
                            </div>
                        </div>
                        <div class="card-body py-4 bg-white">
                            <dl class="row mb-0">
                        ...
                        <div class="card c-brd-light mb-4">
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled c-line-height-2_5 mb-0">
                                    <li><i class="fa fa-credit-card pr-1"></i><small class="c-light">From</small>
                                        <h4 class="d-inline-block c-primary mb-1" id="txtInstallment" runat="server"></h4>
                                        <small class="c-light">with no deposit</small>
                                    </li>
                                    <li id="txtPrice" runat="server"><small class="c-light">Price </small></li>
                                </ul>
                            </div>
    ...
    <!-- End List Details -->
    <!-- Subscribe-->
    <section class="py-2 c-bg-primary text-white sticky">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-6 mb-4 mb-lg-0 align-self-center">
                    <div class="media d-block d-md-flex">
                        <div class="d-md-flex mr-sm-3 mb-3 mb-md-0 align-self-center">
                            <h5 class="text-white c-font-weight-600 mb-0 c-line-height-1_5">Buy Now for <span id="Finance2" runat="server"></span>pm </h5>
                        </div>
                ...
                <div class=" col-lg-6 col-xs-6 col-sm-6">
                    <div class="media-body align-self-center float-right">
                        <a href="#">
                            <img src="dist/images/look4carsbtn.png" alt="" class="img-fluid rounded mr-sm-2" /></a>
